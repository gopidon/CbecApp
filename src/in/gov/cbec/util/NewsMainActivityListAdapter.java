...
public class NewsMainActivityListAdapter extends BaseAdapter {

	private String[] data;
	private LayoutInflater mInflater;
	 
	public NewsMainActivityListAdapter(Context context, String[] items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
    	...
    	if (convertView == null) {
    	    convertView = mInflater.inflate(R.layout.newsmainactivityrow, null);
